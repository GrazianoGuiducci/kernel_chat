...
class ConfigureTests(unittest.TestCase):
    ...
    def test_first_configuration_has_both_entry_paths_and_project_state(self) -> None:
        ...
        self.assertIn("https://github.com/GrazianoGuiducci/kernel_chat", adapter)
        self.assertIn("current main revision", adapter)
        self.assertIn("without claiming it was sent", adapter)
