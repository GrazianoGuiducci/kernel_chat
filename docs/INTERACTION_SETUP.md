# Set up kernel_chat in an AI interaction environment

`kernel_chat` uses an interaction-hosted carrier. A chat is one common case,
...
interaction entry with the actual references available there.
...
## 2. Install the same interaction entry

Use the provider-neutral source:

[Interaction instructions](../adapters/interaction/INSTRUCTIONS.template.md)
...
project knowledge in this interaction scope
...
The new kernel instance enters through the installed interaction entry and
