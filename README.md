...
rereview findings against `1a0720fa...` are reconciled in the current candidate.
...
ordered confirm → commit → push → remote-readback → reentry relation. Any
canonical source change forms a new review target.
